...
export default function RentingPageContent() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">交租</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">管理租客交租記錄</p>
        </div>
        {!isGuestUser && (
          <button
            onClick={() => alert('功能開發中...')}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <p className="text-gray-600 dark:text-gray-400 text-center py-12">交租功能開發中...</p>
      </div>
    </div>
  );
}
